...
public:
    ...
    const typename Tempus::StepperNewmarkExplicitAFormAppAction<double>::ACTION_LOCATION actLoc)
  {
    switch(actLoc) {
      ...
      case StepperNewmarkExplicitAFormAppAction<double>::BEFORE_SOLVE:
      {
      ...
      case StepperNewmarkExplicitAFormAppAction<double>::AFTER_SOLVE:
      {
...
public:
    ...
    const typename Tempus::StepperNewmarkExplicitAFormModifierXBase<double>::MODIFIER_TYPE modType)
  {
    switch(modType) {
      ...
      case StepperNewmarkExplicitAFormModifierXBase<double>::X_BEFORE_SOLVE:
      {
        testX_BEFORE_SOLVE = true;
        testDt = dt;
        break;
      }
      case StepperNewmarkExplicitAFormModifierXBase<double>::X_AFTER_SOLVE:
      {
